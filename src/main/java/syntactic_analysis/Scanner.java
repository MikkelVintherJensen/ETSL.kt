...
public class Scanner {
	...
	static {
		...
		literals.put("function", 4);
		literals.put("event", 9);
		literals.put("agent", 10);
		literals.put("on", 11);
		literals.put("log", 13);
		literals.put("call", 14);
		literals.put("skip", 15);
		literals.put("let", 16);
		literals.put("in", 17);
		literals.put("num", 18);
		literals.put("bool", 19);
		literals.put("string", 20);
		literals.put("list", 21);
		literals.put("record", 24);
		literals.put("true", 37);
		literals.put("false", 38);
		literals.put("head", 43);
		literals.put("tail", 44);
		literals.put("empty", 45);
		literals.put("if", 46);
		literals.put("then", 47);
		literals.put("else", 48);
	...
	Token NextToken() {
		...
		loop: for (;;) {
			switch (state) {
				...
				case 5:
					if (ch <= 9 || ch >= 11 && ch <= 12 || ch >= 14 && ch <= '!' || ch >= '#' && ch <= 65535) {AddCh(); state = 5; break;}
